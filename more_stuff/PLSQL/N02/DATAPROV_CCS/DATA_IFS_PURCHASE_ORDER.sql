...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Procedure DATA_IFS_PURCHASE_ORDER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "DATAPROV"."DATA_IFS_PURCHASE_ORDER" (in_part_no IN VARCHAR2, in_contract IN VARCHAR2, in_quantity IN NUMBER, in_coordinator VARCHAR2, in_supplier VARCHAR2, out_ordernumber OUT VARCHAR2)
IS
...
select * from IFSAPP.purchase_order@IFS021N_IFSAPP where objid = objid_ and objversion = objversion_;

v_order_no ifsapp.purchase_order@IFS021N_IFSAPP%rowtype;

cursor c_get_sales_part is
select * from ifsapp.sales_part@IFS021N_IFSAPP
where contract = v_contract
and PARENT_PART= v_part_no;

v_sales_part_rec ifsapp.sales_part@IFS021N_IFSAPP%rowtype;
...
/
  ...
  GRANT EXECUTE ON "DATAPROV"."DATA_IFS_PURCHASE_ORDER" TO "BATCHPROCESS_USER";
