...
BEGIN
   ...
   -- EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_uk_subs' ;  -- is used next day
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_no_two_mix' ;
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.tm_pc' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_simp' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_bb_base' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.view_correspondence' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.bb_new' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.av_new' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.dp_parentalcontrolapply' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.dp_parentalcontrolchange' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.dp_act_cust_callback' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_bb_lite' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_av_mmf' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_invitems' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_bb_service_visit' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_dtv_psp' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_add_prem' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_sub_upgrad' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_sub_dwgrad' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_est_set_limit' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_est_unset_debt' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_multi_cust_postcodes' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.customerswithrecentorders' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.partyidswithoutaccounts' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.customerforbillreminder' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.updateorderdata' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.estdigitalcontent' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.authorisedigitalcontent' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.despatched_mdu_visits' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.booked_mdu_visits' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.onlineprofileid_cust_search' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.accountswithoutopencase' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_estdisabled' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_techenq' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.hub3orders' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_cust_no_two_mix_mdu' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.dms_document' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.avtelephonyservicecheckid' ;
   ...
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.receipt_stock_order' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.avdiagnostic_ids' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.get_inv_om_preactive' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.ddr_get_cache_nowtv' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.ddr_get_cache' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.act_direct_debit_customers' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.cases_to_close' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.mobile_fulfilment_orders' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.mobile_pending_act' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.accounts_for_ott_est' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.multi_sim_sales' ;
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.loyalty_null' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.mobile_blacklist_cust' ;
   ...
   EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.DATAFORSEGGSERVICE' ;
   ...
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.tel_open_closed_av' ;
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.partyids_open_case_closed_av' ;
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.tel_open_case_closed_av' ;
   --EXECUTE IMMEDIATE 'TRUNCATE TABLE dataprov.tel_bb_or_talk' ;
