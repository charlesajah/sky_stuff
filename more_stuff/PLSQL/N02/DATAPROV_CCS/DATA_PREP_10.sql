...
BEGIN
   ...
   select ROWNUM, l_pool, accountNumber, partyId, portfolioid, messotoken
   from (      SELECT /*+ parallel(cu 8)   parallel(bba 8)  parallel(bpp 8)  */
                     distinct cu.accountNumber, cu.partyid, bba.portfolioid, cu.messotoken
