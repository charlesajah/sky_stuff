...
if page_id != 'Error':
    ...
    child_page_id = createPage("2. Additional Info - " + page_name, page_id, 'CentralChart.txt')
    addlabelstatus =add_labels(child_page_id, labeltouse)
    child_page_id = createPage("3. Database Activity - " + page_name, page_id, 'CentralDBActivity.txt')
    addlabelstatus =add_labels(child_page_id, labeltouse)
    child_page_id = createPage("4. Sql Analysis - " + page_name, page_id, 'CentralSQLComp.txt')
    addlabelstatus =add_labels(child_page_id, labeltouse)
    child_page_id = createPage("5. Load Comparison - " + page_name, page_id, 'CentralLoadComp.txt')
    addlabelstatus =add_labels(child_page_id, labeltouse)
    child_page_id = createPage("6. All SQL Comparison - " + page_name, page_id, 'CentralAllSQLComp.txt')
    addlabelstatus =add_labels(child_page_id, labeltouse)
