...
#     06/05/25   : RFA  : The script will read the Confluence Page name from a text file rather than getting the name via an external parameter 
###################################################################################
# initialize
import requests
import json
...
with open('repname.txt', 'r') as file:
    page_name = file.read()
if page_name == '':
...
page_id = createPage(page_name, 333202389, 'daily_summary.txt') # 333202389 is 'Daily Summaries' page, under "NFT Central Analysis Reporting"
