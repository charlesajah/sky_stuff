#!/usr/bin/python
###################################################################################
# Name : centralAvgSummary.py
# Purpose : Create confluence page using Average Values to create comparison report
# Parameters : 1 = p_test_description free text description field in jenkins job
# Change History :
#   10/02/25    RFA : Initial Version 
###################################################################################
# initialize
import requests
import json
...
page_id = createPage('Classic - ' + page_name, 374407696, 'centralAvgSummaryOrig.txt') # 374407696 is 'New Analysis Reports (TEST)' page, under "NFT Central Analysis Reporting"
addlabelstatus =add_labels(page_id, 'nft_dba')
page_id = createPage('New Approach - ' + page_name, 374407696, 'centralAvgSummary.txt') # 374407696 is 'New Analysis Reports (TEST)' page, under "NFT Central Analysis Reporting"
addlabelstatus =add_labels(page_id, 'nft_dba')
