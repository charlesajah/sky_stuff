...
###################################################################################
# main block
deletePageByTitle("N02 Database Growth");
page_id = createPage("N02 Database Growth", 198648455, 'space.txt')  # 198648455 is 'NFT Database Space' page.
print("N02 Database Growth Page created under https://confluence.bskyb.com/display/nonfuntst/NFT+Database+Space")

deletePageByTitle("N02 Schema Growth");
page_id = createPage("N02 Schema Growth", 198648455, 'schema_space.txt')  # 198648455 is 'NFT Database Space' page.
print("N02 Schema Growth Page created under https://confluence.bskyb.com/display/nonfuntst/NFT+Database+Space")

deletePageByTitle("N02 Tablespace Growth");
page_id = createPage("N02 Tablespace Growth", 198648455, 'ts_space.txt')  # 198648455 is 'NFT Database Space' page.
print("N02 Tablespace Growth Page created under https://confluence.bskyb.com/display/nonfuntst/NFT+Database+Space")
###################################################################################
